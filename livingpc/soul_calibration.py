...
FIELDS = [
    {"section": "Style Anchors", "attribute": "favorite movies", "priority": 72,
     ...
     "example": "\"A gritty action film. For research purposes.\""},
    {"section": "Style Anchors", "attribute": "favorite tv shows", "priority": 72,
     "label": "Favorite TV show",
     "prompt": "Favorite TV show?",
     "example": "\"A hundred-year-old costume drama I maintain has surprisingly good pacing.\""},
    {"section": "Style Anchors", "attribute": "favorite non-fiction books", "priority": 70,
     ...
     "example": "A biography of a Victorian engineer that comes up in conversation more than it should."},
    {"section": "Style Anchors", "attribute": "favorite fiction books", "priority": 70,
     ...
     "example": "A nine-hundred-page fantasy series you describe, unconvincingly, as \"light reading.\""},
    {"section": "Style Anchors", "attribute": "favorite songs", "priority": 68,
     "label": "Favorite song",
     "prompt": "A song that means something to you?",
     "example": "Something you would deny liking under formal questioning."},
    {"section": "Style Anchors", "attribute": "other beloved references", "priority": 68,
     ...
     "example": "Village fetes, a suspiciously competitive interest in hedges, or a market town you have Opinions about."},
    {"section": "Current Reality", "attribute": "current work situation", "priority": 98,
     ...
     "example": "\"Technically employed. Emotionally, still reviewing the options.\""},
    {"section": "Body & Energy", "attribute": "current body and energy realities", "priority": 94,
     ...
     "example": "\"Structurally sound, if a bit creaky after 30. Nothing to file a report over.\""},
    {"section": "Fear & Protection", "attribute": "recurring threats that are not always real threats", "priority": 92,
     ...
     "example": "Treating small talk at the till as an exam you're quietly failing."},
    {"section": "Values & Identity", "attribute": "values and identity anchors", "priority": 96,
     ...
     "example": "\"Queueing properly matters to me more than is probably healthy.\""},
    {"section": "Relationships", "attribute": "relationship and support context", "priority": 88,
     ...
     "example": "A neighbour who \"just popped round\" four times this week, entirely unbidden."},
    {"section": "Dreams & Direction", "attribute": "dreams and desired direction", "priority": 90,
     ...
     "example": "Quietly plotting a move somewhere with fewer meetings and more sheep."},
    {"section": "Core Identity", "attribute": "other essential context", "priority": 86,
     ...
     "example": "\"I apologise to furniture when I walk into it. Apparently this is notable.\""},
]
